namespace ExampleFramework.ImNodesZoomDemo
{
    using ExampleFramework.NodeEditorZoom;
    using Hexa.NET.ImGui;
    using Hexa.NET.ImNodesZoom;

    public class ImNodesZoomDemo
    {
        private NodeEditorZoom editor = new();

        public ImNodesZoomDemo()
        {
            editor.Initialize();
